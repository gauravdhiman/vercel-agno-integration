        ...
        return Function(
            ...
            parameters={
                ...
                "properties": {
                    "frontend_tool_name": {
                        "type": "string",
                        "description": "The specific name of the action the frontend application should perform (e.g., 'ask_user_confirmation', 'display_product_card' etc). Refer to agent instructions for available frontend_tool_names and their argument schemas."
                    },
                    "frontend_tool_args": {
                        "type": "object",
